...
export const MultiWindowManager: React.FC<MultiWindowManagerProps> = ({
  ...
  const toolbarBtnClass = isLight
    ? 'flex items-center space-x-1.5 px-3 py-1.5 text-xs font-bold text-slate-800 hover:text-slate-950 bg-white hover:bg-slate-50 rounded-lg border-2 border-slate-300 shadow-xs transition cursor-pointer'
  ...
  const entitySetupBtnClass = isLight
    ? 'flex items-center space-x-1.5 px-3 py-1.5 text-xs font-black text-emerald-950 hover:text-emerald-950 bg-white hover:bg-emerald-50 rounded-lg border-2 border-emerald-600 shadow-xs transition cursor-pointer'
    ...
    <div className={`relative w-full flex-1 min-h-0 h-[calc(100vh-5rem)] flex flex-col overflow-hidden select-none ${
      ...
      <div className={topToolbarClass}>
        ...
        <div className="flex items-center space-x-1.5">
          ...
          >
            <Landmark className={`w-3.5 h-3.5 ${isLight ? 'text-emerald-700' : 'text-emerald-500'}`} />
